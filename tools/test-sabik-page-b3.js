...
async function run() {
  ...
  assert(
    "B3-014 all five exact B3 files match the approved SHA-256 hashes",
    Object.entries({presente:"38231a12d48432a004b874bff7f80752a02f394a842f82d3b91125ea06c3d1ef",orientar:"6fb4155ec1dc4eaf541b8f017b81c73e1044d04ce081b1c0d5add00e19d76133",transicion:"b95014a9d1bc6d3036b71f98db244af75934a854c1c40bbf8125ceeaaf9f29f7",pausa:"62ff4653833d130e774b3a9da074f6cc5588ea2a2dbdd4f582a5f05db96b580c",confirmar:"4fe709c5212542c7a597173d672e626bbbfd23429abc0d4bea446ed5e37cb053"}).every(([name,hash]) => require("node:crypto").createHash("sha256").update(fs.readFileSync(path.join(root,"sabik/assets/web-r01/web_"+name+".png"))).digest("hex") === hash),
    "Bytes of the accepted masters are immutable."
  );
