...
A2 sigue siendo la única puerta a la web.

## Integración
1. clasificación A4;
2. implementación A3;
3. enlaces seguros A1;
4. resolver conflictos con R42 app shell sin perder protección.

## Gate obligatorio en preview
Comprobar ES/EN, desktop/móvil y al menos:
- Infancia: catálogo filtrado + 0 recomendaciones S2;
- Adolescencia: S2 solo mediante intención clara;
- Adultez: catálogo completo;
- Cualquier edad: safe-by-default;
- acceso desde un juego infantil no desemboca accidentalmente en S2;
- acceso directo a ficha S2 muestra primero una superficie segura;
- no DOB/cuenta/red para la preferencia de etapa;
- no-JS sigue siendo seguro.

No declarar PASS por CI sin HUMAN QA de María.

Estado: `R42_A2_CHILD_SAFE_WEB_PREVIEW_READY_FOR_HUMAN_QA`.
