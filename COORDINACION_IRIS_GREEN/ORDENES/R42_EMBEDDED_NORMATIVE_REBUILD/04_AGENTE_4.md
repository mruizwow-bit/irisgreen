...
### Portada
- 11 grupos visuales con previews;
- búsqueda/Actions;
- no 11 acordeones gigantes;
- no 72 tarjetas de texto simultáneas.

### Detalle
Primero una experiencia explorable adecuada al tema: atlas, mapa, timeline, diagrama, sonido, simulación, visor, colección visual.
Selector compacto de modos; **un panel activo cada vez**.
Fuentes/colección secundarias en drawer/panel.
...
- diario;
- tu rincón.
Mantener `REAL_DATA / SIMULATION / USER_CREATED / FICTIONAL`.

### Diseño
Contemporáneo, tipo atlas/laboratorio; no catálogo documental ni estética infantil.
Storage compartido A5; cero tracking/red indebida.
ES/EN completo.

### Gate
Si empieza con párrafos/filtros/listas antes de la experiencia visual, FAIL.
Entrega patch real a A2.
Estado: `R42_A4_INTERESTS_FIELDNOTEBOOK_READY_FOR_A2`.
