...
## PARTE DE LA EVIDENCIA REAL DE MARÍA
La portada y el estudio de dibujo actuales fallan HUMAN QA: acordeones gigantes, Mi colección al final, retos antes del lienzo, demasiados botones iguales y workspace relegado.

## CONSTRUIR

### Portada
- seis áreas como launcher visual, no seis `details` grandes;
- previews reales/microherramientas;
- Continuar / proyectos recientes arriba si existen;
- búsqueda/Actions;
- Mi colección/Proyectos en panel de gestión, no texto “• —” y cuatro botones de borrado expuestos.
...
- reto/ayuda en drawer;
- Archivo agrupa Nuevo/Abrir/Guardar/Exportar/Imprimir;
- colección/progreso no invade toolbar creativa.

Aplicar al conjunto de 25 estudios. No entregar “25 páginas existen” como evidencia visual.

### Interacción
Manipulación directa cuando proceda: seleccionar, mover, arrastrar, redimensionar, conectar, dibujar, snapping, handles, contextual properties. Teclado equivalente.

### Familias
Dibujo/pixel/cómic, estructuras/circuitos, programación/robótica/videojuegos, ritmo/composición/síntesis, escritura/mundos/lenguas, mesa/fotografía/moda/ideas deben sentirse como herramientas distintas aunque compartan infraestructura.

### Mobile
Workspace primero; bottom dock y bottom sheets; nada de columna interminable.

Conservar capa local segura y privacidad. ES/EN completo.
Entrega patch real a A2.
