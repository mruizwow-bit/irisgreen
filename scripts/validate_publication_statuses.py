...
No toca la indexación: los meta robots se conservan tal como llegan a la salida. Los avisos de
«trabajo pendiente» de Vivir fuera y Cuestionarios se reformulan como alcance de la ficha.
La comprobación final la hace finalize_validation_labels.py.
"""
