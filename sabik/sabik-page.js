(() => {
  ...
  function setStatus(message, visual = "base") {
    ...
    if (["Preferencia de respuesta aplicada.", "Respuesta más corta activada.", "Baja intensidad activada.", "Intensidad normal activada."].includes(message)) {
      applySabikVisual(state.session && state.session.sabik_state, "confirmacion");
    }
