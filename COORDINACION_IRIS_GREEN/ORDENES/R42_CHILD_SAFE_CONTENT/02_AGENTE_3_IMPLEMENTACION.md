...
Parent: #293
Depende de clasificación A4.

## CONSTRUIR EN PRODUCTO

### Selector global de etapa
En Situaciones y Condiciones, visible y claro:
**Contenido para: Infancia · Adolescencia · Adultez · Cualquier edad**

No preguntar fecha de nacimiento.
No cuenta.
No servidor.
No perfil.
...
- navegación incidental protege como `Cualquier edad`;
- S2 no se promociona/recomienda;
- sí debe existir una ruta clara para buscar ayuda intencionadamente.

### Catálogos
- filtrar por audiencia;
- mostrar solo fichas apropiadas;
- permitir cambiar de etapa sin perder contexto;
- contador refleja la selección;
- ES/EN.

### Buscador global
Extender `buscador.json`/índice común para usar:
- audience;
- sensitivity;
- discovery.

Resultados S2:
- no autocomplete/recomendación incidental en Infancia;
- en Adolescencia, solo ante intención clara;
- en Cualquier edad, no promoción incidental;
- Adultez, catálogo completo.

### Fichas sensibles
Construir shell de versión segura:
- aviso neutral, no alarmista;
- resumen apropiado a etapa;
- sin métodos ni detalles gráficos;
- botón/ruta de ayuda;
- versión completa solo según política de etapa/discovery;
- foco/teclado/lector/zoom.

### No-JS
La protección no puede depender solo de JavaScript. La salida estática debe ser segura por defecto.

### Entrega
Código real + tests + ES/EN + móvil.
Patch a A2.
Estado: `R42_A3_CHILD_SAFE_ROUTING_SEARCH_READY_FOR_A2`.
