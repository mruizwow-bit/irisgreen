...
## CONSTRUIR SOBRE R04, NO VOLVER A R03

Conservar los activos audiovisuales válidos de R04, pero finalizar la experiencia como herramienta inmersiva actual.

### Orden visible
Vídeos / Sonidos / Bola → stage activo inmediatamente.
Controles esenciales junto al stage.
Selector compacto después/lateral.
Ajustes secundarios en inspector/drawer.

### Inmersión
Pantalla limpia reduce chrome; controles reaparecen por interacción/foco sin perder accesibilidad.
Mobile: stage primero + bottom sheet.

### Audio
12 sonidos + 9 ambientes deben ser distintos, relajantes, sin hiss, viento genérico, loops evidentes, pads invasivos ni sobresaltos. HUMAN QA auditiva obligatoria.
...
### Gate
No PASS por hashes/CI. Si María lo abre y el stage no domina o el audio no funciona perceptivamente, vuelve a construcción.
