...
# ORDEN ESPECÍFICA R42 · AGENTE 2

Parent: #283
Issue operativo: #289

A2 es única puerta a la web.

1. Terminar la integración Sabik R06 que esté activa sin perderla.
2. Rechazar cualquier entrega R42 que no declare `R42_NORMATIVA_EMBEBIDA_LEIDA`.
3. Integrar por orden: A3 app shell → A5 Taller → A1 Recursos/Juegos/Rutinas → A4 Intereses/Cuaderno → A7 Rincón.
4. No resolver conflictos regresando a listas/acordeones/formularios.
5. Build + CI + Deploy Preview PR244.
6. Entregar HEAD/tree/deploy/URL.
7. HUMAN QA de María en web real, desktop y móvil.
8. No declarar PASS final por CI verde, conteos, rutas o capturas locales.
9. No main/producción sin autorización.
10. Actualizar Memoria y Control al cerrar cada integración.

Estado: `R42_A2_FULL_PREVIEW_READY_FOR_HUMAN_QA`.
