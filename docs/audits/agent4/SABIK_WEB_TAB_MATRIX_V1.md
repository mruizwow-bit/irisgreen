...
| Vida diaria | 48 fichas en 6 categorías; 48/48 fichas fuente con validación 10/09/2026 | Auditar fuente → staging → dist; mantener revisión interna por ficha | El índice fuente conserva BORRADOR, pero el build publica/valida en staging y después elimina estados editoriales de dist | Pasos accionables, recursos España, “qué preparar” | No sustituir estados a mano: corregir la fuente canónica o el publicador cuando proceda | Registro de mantenimiento interno por ficha | Probar el artefacto final: búsqueda, listas, tablas, enlaces y estados no expuestos | WCAG; ISO 24495-1; RD 707/2026; legislación sectorial por ficha | es/biblioteca/index.html + fichas + scripts/publish_biblioteca.py + scripts/strip_daily_public_status.py | 27/09/2026 |
