...
assert.equal(manifest.schema,'SABIK_B3_RUNTIME_ASSETS_R1_CURRENT_BASE');
...
for(const item of manifest.runtime.files){
  ...
  assert.deepEqual(item.dimensions,[64,64],item.file+' normalized runtime size');
}
...
console.log('SABIK_B3_INTEGRATION_R1_PASS');
