...
Revisar Juegos, Rutinas, Tarjeta Iris y Recursos para que todos los enlaces cruzados respeten la lente por etapa/sensibilidad.

### Obligatorio
- un juego INFANCIA nunca enlaza incidentalmente a S2;
- “Relacionado”, “Sigue explorando”, recomendaciones y buscadores respetan audience/sensitivity/discovery;
- recursos de Adolescencia no generan rabbit holes a S2;
- si un juego trata pedir ayuda, acoso o seguridad, enlazar a la **versión segura apropiada**, no eliminar la ayuda;
- no usar diagnóstico como puerta;
- ES/EN.

### Datos
Añadir a cada juego/recurso:
- audience;
- safe_related_topics;
- blocked_related_topics cuando proceda.

### QA
Crear casos automáticos:
- infancia→S2 = 0 enlaces incidentales;
- adolescencia→S2 = solo explicit/intencional;
- adultez = catálogo completo;
- cualquier edad = safe-by-default.

Actualizar Memoria/Control.
Estado: `R42_A1_RESOURCES_SAFE_LINKING_READY_FOR_A2`.
