...
R={'cases':[],'failures':[],'notes':['Checks real in-place ES/EN switching on Living abroad.','Official programme/law names may remain in their original language.','This is a translation/function test, not evidence validation.']}
