...
for p in html_files:
    ...
    for lang,href in parser.lang_links:
        ...
        # Query-string links to a same-language document do not count as an English
        # destination unless the page is a dynamic implementation tested below.
...
try:
    ...
    with sync_playwright() as pw:
        ...
        ctx.close()
        # Follow every distinct English-menu destination from a clean, real English
        # condition page. This catches English -> Spanish regressions between sections.
