...
**ESTE TEXTO ESTÁ COPIADO DENTRO DE ESTA ORDEN POR DECISIÓN EXPRESA DE MARÍA. NO SE SUSTITUYE POR UN ENLACE.**
...
5. leer esta orden;
6. publicar en el issue: `R42_NORMATIVA_EMBEBIDA_LEIDA`;
7. construir en la misma sesión;
8. actualizar Memoria + Control al terminar.

**El acuse no es una fase de espera. Se publica y se empieza a construir en la misma sesión.**
**A2 rechazará cualquier entrega R42 sin `R42_NORMATIVA_EMBEBIDA_LEIDA`.**
...
# ORDEN ESPECÍFICA R42
Parent: #283

## CONSTRUIR

Aplicar literalmente el brief embebido de juegos/rutinas/pictogramas.

### Recursos
Hub visual con Juegos, Rutinas visuales, Rutinas imprimibles, Tarjeta Iris y Descargas. No directorio técnico.

### Juegos
- inventariar el estado público vigente sin reintroducir como fuente los 130 juegos retirados que el bloque prohíbe;
- biblioteca final de al menos 200 juegos/actividades únicos tras deduplicar, o más si el estado aprobado vigente ya supera esa cifra;
- todas las edades: infancia, adolescencia, adultez y transversal;
- filtros por etapa/contexto/habilidad/duración/tipo;
- image-first cuando sea viable;
- teclado + alternativa textual + reduced motion;
- sin lenguaje diagnóstico.

### Experiencia play-first
No formularios repetidos.
Familias interactivas reales:
- ordenar/secuenciar;
- qué falta;
- elegir primer paso;
- clasificar;
- preparar objetos;
- planificar ruta/salida/trámite;
- timeline/board;
- memoria visual;
- emparejar;
- simulación cotidiana.
Drag nunca único método.

### Rutinas
Las 92 rutinas deben avanzar hacia salida descargable útil; cada una al menos un formato público válido. ES/EN según el bloque. Watermark obligatoria en descargables Iris Green. Mantener atribución/licencia de pictogramas. No ARASAAC mientras siga descartado. Mulberry según expediente y trazabilidad.

### Arquitectura pública
Nunca mostrar lenguaje interno: B0/B1/piloto, mapeos, IDs QA, “427/427”, etc.

### Gate
Superficie de juego primero. Si parece cuestionario o catálogo textual cuando puede ser interactivo, FAIL.

Entrega código + datos + descargables/plantillas reales a A2.
