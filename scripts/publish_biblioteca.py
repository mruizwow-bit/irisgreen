...
REVIEW_DATE = "10 de septiembre de 2026"
...
# Beca NEAE: fecha exacta sin texto temporal y nota del BOE corregida.
...
# Universidad: fuente legal directa para ajustes en docencia y evaluación.
...
# Empleo: precisión sobre diagnóstico y datos de salud.
...
# Fuentes clínicas específicas donde antes había una base insuficiente o demasiado general.
...
# NICE NG69 no cubre ARFID ni pica: se añaden fuentes específicas.
...
# Portada: estado visible y número de fuentes real de cada ficha.
