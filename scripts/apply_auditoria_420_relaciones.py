...
- 49 Vida diaria ES + 49 EN: retira la nube de relaciones de cada detalle y la taxonomía pública del índice.
...
def main() -> None:
    ...
    results["vida_en"] = apply_collection(root / "en/everyday-life", 49, DAILY_HEADINGS_EN, "Everyday life EN")
