...
def page(mod, lang: str) -> str:
    ...
    body = (
        ...
        + f'<div id="igt-app" class="igt-app" data-study-id="workshop-{mod.NUMBER:02d}" data-studio="{mod.KEY}"><div class="igt-nojs"><p>{e(t["noJs"])}</p>{static_challenges(mod, lang)}</div></div>'
