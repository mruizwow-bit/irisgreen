...
## EJECUTA, NO REDACTES OTRO INFORME

Construye sobre la web vigente una capa de producto moderna y reutilizable para Taller, Juegos, Intereses y Rincón.

### Resultado obligatorio
- cabecera compacta;
- workspace central visible en primer viewport;
- tool rail/context toolbar;
- inspector contextual;
- drawers/sheets/popovers para secundarios;
- project/status discreto;
- command/actions;
- mobile con bottom dock/sheet, no desktop apilado.

### Prohibido
- usar grandes acordeones como arquitectura principal;
- listas enormes antes de la herramienta;
- filas de 8–12 botones iguales;
- controles nativos sin acabado;
- modernizar solo colores/bordes;
- añadir otro framework por estética.

### Tecnología autorizada con fallback
Container Queries, Popover, dialog, View Transitions + reduced motion, OffscreenCanvas/Workers, IndexedDB/OPFS, File System Access opcional, WebGL2; WebGPU solo opcional.

### Gate
Si el workspace no domina el primer viewport o parece documento/formulario, FAIL aunque CI esté verde.
