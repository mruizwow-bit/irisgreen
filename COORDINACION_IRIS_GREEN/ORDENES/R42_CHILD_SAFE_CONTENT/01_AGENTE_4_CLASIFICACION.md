...
# ORDEN ESPECÍFICA · R42 CHILD SAFE CONTENT

Parent: #293

## CONSTRUIR EL REGISTRO CANÓNICO, NO UN INFORME NARRATIVO

Inventariar las **185 Condiciones + 187 Situaciones** actuales ES/EN y asignar a cada ficha metadatos revisados humanamente:

- `audience`: infancia | adolescencia | adultez | transversal (array; puede ser multi-etapa)
- `sensitivity`: S0_GENERAL | S1_SENSITIVE | S2_HIGH_SENSITIVITY
- `discovery`: NORMAL | INTENTIONAL_ONLY | SAFE_VARIANT_REQUIRED
- `child_variant`: ruta/estado
- `teen_variant`: ruta/estado
- `support_route`: si procede
- `review_reason`
- fuente/fecha/versión de clasificación

### Criterios
No clasificar solo por palabras clave.
Revisar contenido real.

S2 incluye, entre otros, cuando el contenido lo justifique:
- autolesión/suicidio;
- violencia/abuso/explotación con detalle;
- trauma grave;
- conductas alimentarias con riesgo de imitación;
- cualquier explicación que pueda resultar dañina por exposición incidental.

### Importante
No marcar automáticamente abuso, acoso, consentimiento o salud mental como “solo adultos”. Cuando un menor necesita esa información, debe existir versión segura y útil para pedir ayuda.

### Entrega
- JSON ES/EN machine-readable;
- lista de fichas que requieren versión infancia;
- lista de fichas que requieren versión adolescencia;
- lista S2;
- 0 huecos sin clasificar;
- no modificar producto todavía;
- actualizar Memoria/Control.

Publicar `R42_NORMATIVA_EMBEBIDA_LEIDA` y ejecutar.
Estado: `R42_A4_372_CONTENT_CLASSIFICATION_READY`.
