...
const executorPath=path.resolve(arg("--executor",path.join(root,"tools/sabik-i0-executor-v3-r2.mjs")));
...
const outputPath=path.resolve(arg("--output",path.join(root,"docs/sabik-next/I0_V3_R2_LITERAL_PROVENANCE_AUDIT.json")));
...
const audit={
  version:"I0_V3_R2_LITERAL_PROVENANCE_AUDIT_V1",
